...
import com.boot.bussiness.AutowiringSpringBeanJobFactory;
import com.boot.bussiness.EmailHistory;
...
public class SchedulerConfig {
    ...
    public SimpleTriggerFactoryBean simpleJobTrigger(@Qualifier("simpleJobDetail") JobDetail jobDetail,
            @Value("${checkRequestStatus.frequency}") long frequency) {
    ...
    public JobDetailFactoryBean simpleJobDetail() {
        ...
        factoryBean.setJobClass(EmailHistory.class);
